...
namespace CMS.User.Staff
{
    public partial class StaffList : System.Web.UI.Page
    {
        ...
        private void LoadData()
        {
            ...
            string sql = "EXEC Proc_Teacher @flag='SelectStaff'";
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                sb.Append("<td>");
                sb.Append("<a href='/User/UpdateList/UpdateStaff.aspx?rowID=" + dr["rowID"].ToString() + "'><input type='button' value='EDIT' class='btn btn-primary'/></a>");
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            sql = sql + " @flag='DeleteStaff_By_RowId'";
            sql = sql + ",@rowID='" + id + "'";
            DataSet ds = obj.ExecuteDataSet(sql);
            ...
            if (code == "0")
            {
                ...
                Response.Redirect("/User/Staff/StaffList.aspx");
            }
            else
            {
                ShowAlert(msg);
